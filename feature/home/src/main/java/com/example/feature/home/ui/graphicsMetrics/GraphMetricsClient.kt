...
import com.avilesrodriguez.presentation.graphs.BulletsGraphClient
...
@Composable
fun GraphMetricsClient(
    user: UserData.Client,
    metrics: ReferralMetrics,
    winByReferral: Double,
...
private fun MetricsClient(
    ...
    Column(
        ...
        BulletsGraphClient(
            moneyEarned = user.moneyEarned.toFloat(),
            winByReferral = winByReferral.toFloat(),
            modifier = Modifier.padding(8.dp)
        )
