...
class GetReferralsByClientPaged @Inject constructor(
    ...
    suspend operator fun invoke(clientId: String, pageSize: Long, lastReferral: Referral?) : Pair<List<Referral>, Referral?>{
        return repository.getReferralsByClientPaged(clientId, pageSize, lastReferral)
    }
}