...
interface IReferralRepository {
    ...
    suspend fun getReferralsByClientSince(clientId: String, since: Long, toDate: Long?, isPaymentsScreen: Boolean) : Flow<List<Referral>>
    suspend fun getReferralsByProviderSince(providerId: String, since: Long, toDate: Long?, isPaymentsScreen: Boolean) : Flow<List<Referral>>
